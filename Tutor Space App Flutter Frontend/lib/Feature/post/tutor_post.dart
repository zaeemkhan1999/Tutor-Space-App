...
import 'package:tutorez_project/Feature/post/tutorpost_provider.dart';
...
class TutorPost extends StatefulWidget {
  const TutorPost({super.key});

  @override
  State<TutorPost> createState() => _TutorPostState();
}

class _TutorPostState extends State<TutorPost> {
  final SecureStorage secureStorage = SecureStorage();
  @override
  Widget build(BuildContext context) {
    final TutorPostprovider = Provider.of<TutorPostProvider>(context);
    void postStudentdetail() async {
      ...
      var data = {
        'title': TutorPostprovider.titleController.text,
        'description': TutorPostprovider.descriptionController.text,
        'subject': TutorPostprovider.subjectController.text,
        'price_range': TutorPostprovider.priceController.text,
        'duration': TutorPostprovider.durationController.text,
        'requirement': TutorPostprovider.requirmentController.text,
      };
      print(data);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller: TutorPostprovider.titleController,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller: TutorPostprovider.subjectController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            focusedBorder: InputBorder.none,
                            enabledBorder: InputBorder.none,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller: TutorPostprovider.descriptionController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            focusedBorder: InputBorder.none,
                            enabledBorder: InputBorder.none,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller: TutorPostprovider.priceController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            focusedBorder: InputBorder.none,
                            enabledBorder: InputBorder.none,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller: TutorPostprovider.durationController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            focusedBorder: InputBorder.none,
                            enabledBorder: InputBorder.none,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller: TutorPostprovider.requirmentController,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            focusedBorder: InputBorder.none,
                            enabledBorder: InputBorder.none,
