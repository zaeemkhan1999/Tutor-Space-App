...
import 'package:tutorez_project/Feature/map/tutor_home_provider.dart';
import 'package:tutorez_project/Feature/post/tutor_post.dart';
...
class _TutorHomeState extends State<TutorHome> {
  ...
  void initState() {
    ...
    context.read<TutorHomeProvider>().fetchOrgs();
    ...
    Future.delayed(Duration(seconds: 1), () {
      List<dynamic> list = context.read<TutorHomeProvider>().list;
      print(list.length);
      loadData(list);
    });
  }
          ...
          Positioned(
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => TutorPost()),
                );
              },
            ),
          ),
