...
class TutorSignupSecondScreen extends StatefulWidget {
  const TutorSignupSecondScreen({super.key});

  @override
  State<TutorSignupSecondScreen> createState() =>
      _TutorSignupSecondScreenState();
}

class _TutorSignupSecondScreenState extends State<TutorSignupSecondScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    void postStudent() async {
      final url = Uri.parse('http://10.0.2.2:3000/tutor/signup');
