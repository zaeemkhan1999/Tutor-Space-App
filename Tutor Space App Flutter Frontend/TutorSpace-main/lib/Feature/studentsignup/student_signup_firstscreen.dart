...
class StudentSignupFirstScreen extends StatefulWidget {
  const StudentSignupFirstScreen({super.key});

  @override
  State<StudentSignupFirstScreen> createState() =>
      _StudentSignupFirstScreenState();
}

class _StudentSignupFirstScreenState extends State<StudentSignupFirstScreen> {
  @override
  Widget build(BuildContext context) {
    final signupProvider = Provider.of<StudentSignupProvider>(context);
    return Scaffold(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.of(context).push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const StudentSignupSecondScreen()));
                      },
                      style: TextButton.styleFrom(
                        padding: EdgeInsets.zero,
                      ),
